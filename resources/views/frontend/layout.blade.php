...
<html lang="en">
  <head>
    <title>CarRental &mdash; By Rizal Nugrahanto</title>
    <meta charset="utf-8" />
    <meta
      name="viewport"
          ...
          <div class="row">
            ...
            @if ($setting)
              ...
              <ul class="list-unstyled social">
                <li>
                  <a href="https://github.com/rzalra"><span class="icon-github"></span></a>
                </li>
                <li>
                  <a href="https://www.instagram.com/rzalra?igsh=cm4zanJidWxiZWY2&utm_source=qr"><span class="icon-instagram"></span></a>
                </li>
                <li>
                  <a href="https://wa.me/6282322625256"><span class="icon-whatsapp"></span></a>
                </li>
                <li>
                  <a href="https://www.facebook.com/profile.php?id=100081934884393"><span class="icon-facebook"></span></a>
                </li>
              </ul>
            @endif
            </div>
            ...
            <div class="col-md-12">
              <div class="border-top pt-5">
                <p>
                  ...
                  <a href="https://www.instagram.com/rzalra?igsh=cm4zanJidWxiZWY2&utm_source=qr" target="_blank">Rzalra</a>
                </p>
              </div>
            </div>
          </div>
